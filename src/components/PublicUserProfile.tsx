...
function PublicUserProfileContent({ userId, onBack, onSelectIntent }: PublicUserProfileProps) {
  ...
  async function handleCopyProfileLink() {
    const ok = await copyToClipboard(getUserProfileShareUrl(userId));
    setCopySuccess(ok);
        ...
        <div className="space-y-8">
            ...
            <div className="px-6 pb-6 pt-0 sm:px-8 sm:pb-8 relative">
              ...
              <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-12 sm:-mt-14 mb-4">
                <div className="flex items-end gap-4 min-w-0">
                  ...
                  <div className="mb-1 min-w-0 break-words">
          ...
          <section aria-labelledby="social-identity-heading" className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <dl className="grid grid-cols-2 gap-3">
                {/* Card 1: Seguidores */}
                <div
                  className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-[#000666]/30 transition-all flex flex-col justify-between group"
                >
                  <dt className="flex items-center justify-between text-xs font-bold text-[#666] mb-2">
                    <button type="button" className="min-h-[44px] text-left hover:underline"
                      onClick={() => handleOpenConnectionsModal('followers')}>Seguidores</button>
                ...
                >
                  <dt className="flex items-center justify-between text-xs font-bold text-[#666] mb-2">
                    <button type="button" className="min-h-[44px] text-left hover:underline"
                      onClick={() => handleOpenConnectionsModal('following')}>Seguindo</button>
              ...
              <dl className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
                ...
                <div className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-rose-500/30 transition-all flex flex-col justify-between">
                  ...
                  <dd className="space-y-1">
                    ...
                    <p className="text-[11px] text-[#777] leading-tight">Apoios recebidos em Intents públicas.</p>
                  </dd>
                </div>
              ...
              <dl className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-rose-500/30 transition-all flex flex-col justify-between">
                  ...
                  <dd className="space-y-1">
                    ...
                    <p className="text-[11px] text-[#777] leading-tight">Apoios mantidos em Intents públicas.</p>
                  </dd>
                </div>
                ...
                <div className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-amber-500/30 transition-all flex flex-col justify-between">
                  ...
                  <dd className="space-y-1">
                    ...
                    <p className="text-[11px] text-[#777] leading-tight">Reações atuais em Intents públicas.</p>
                  </dd>
                </div>
                ...
                <div className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-indigo-500/30 transition-all flex flex-col justify-between">
                  ...
                  <dd className="space-y-1">
                    ...
                    <p className="text-[11px] text-[#777] leading-tight">Comentários em Intents públicas.</p>
                  </dd>
                </div>
                ...
                <div className="rounded-2xl border border-[#e4e2de] bg-white p-4 shadow-sm hover:border-emerald-500/30 transition-all flex flex-col justify-between">
                  <dt className="flex items-center justify-between text-xs font-bold text-[#666] mb-2">
                    <span>Participações em acontecimentos realizados</span>
                    <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                  </dt>
                  <dd className="space-y-1">
                    <span className="text-2xl font-black text-emerald-700">
                    ...
                    <p className="text-[11px] text-[#777] leading-tight">Intents públicas realizadas com participação.</p>
                  </dd>
                </div>
              </dl>
            </div>
          ...
          <section className="rounded-2xl border border-[#e4e2de] bg-gradient-to-br from-white to-[#f7f6fc] p-5 sm:p-6 shadow-sm">
            ...
            <p className="text-sm text-[#444] leading-relaxed">
              No Intent, a identidade social reúne criação de acontecimentos, apoios, reações, comentários e conexões entre pessoas.
          ...
          <div className="space-y-6 pt-2">
            ...
            <div className="flex items-center gap-2 border-b border-[#e4e2de] pb-2">
              ...
              <button
                ...
                aria-pressed={activeTab === 'intents'}
                className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold transition-all min-h-[44px] ${
                  activeTab === 'intents'
                    ? 'bg-[#000666] text-white shadow-sm'
                    : 'bg-[#f7f6fc] text-[#555] hover:bg-[#e0e0ff]/60 hover:text-[#000666]'
