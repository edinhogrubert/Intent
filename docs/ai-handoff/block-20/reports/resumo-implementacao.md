...
Código reaproveitado de intentNew @ 9616376, com ajustes de cancelamento no carregamento, descrição de apoios e quebra de nomes longos. Somente componente e documentação integrados; contrato autenticado existente preservado. Validações oficiais e limitações estão em `validacoes.md`.
